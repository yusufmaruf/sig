...
<body>
    ...
    function initMap() {
        ...
        downloadUrl('http://localhost/sig/data-json.php', function(data) {
            var markers = JSON.parse(data.responseText);
            Array.prototype.forEach.call(markers, function(element) {
                var id = element.id;
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrMB_B5LP4_WVpTA174pqlc4EofMxMf6M&callback=initMap"
        defer></script>
</body>
